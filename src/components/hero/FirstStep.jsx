  ...
  console.log(form);
    ...
    useEffect(() => {
        ...
        if (categoryId) {
          ...
          getSubCategories(categoryId,token).then(res => {
        ...
        <div className='p-3' style={{display:display}}>
            <div className="row ">
                <div className='col-lg-12 col-md-12'>
                    <TextField id="filled-basic" label="Blog Title" variant='filled' required fullWidth name='title' value={form.title || ""} onChange={e=>{
                        console.log(form)
                         setForm({
                            ...form,
            ...
            <div className="row mt-4" style={{
                ...
                <div className="col-sm-12 col-md-6 col-lg-6">
                    <Autocomplete
                        ...
                        <TextField 
                        {...params} 
                        required label="Choose Category" 
                        />}
            ...
            <div className="row pt-3 mb-5">
                    ...
                    <ReactQuill theme={"snow"} value={form.text || ""} onChange={(event) => setForm({
                        ...form,
                        text:event
                    })}
                    />
