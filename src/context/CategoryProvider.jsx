...
import { getCategories,getSubCategories,addSubCategory,addCategory,getAllSubCategories,editCategory,editSubCategory,deleteCategory,deleteSubCategory } from '../apis/category'
...
//    }
    ...
    const allSubcategores = ( token) => {
         ...
         getAllSubCategories(token).then(res =>{
