...
function EditPost() {
  ...
  const { getSinglePost, successMsg, errorMsg, setErrorMsg, post, updatePost, setSuccessMsg, loading } = postContext
  useEffect(() => {
        ...
        <div className='col-sm-12 col-md-12 col-lg-9 mt-2'>
          <div className="card" >
            ...
            <div className="card-body overflow-auto">
              ...
              <ImageUpload successMsg={successMsg}  imgs={imgs} setImgs={setImgs} value={value}/>
              ...
              style={{
                ...
                className='btn btn-secondary' onClick={() => handleUpdate()} >
